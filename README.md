...
**Edit 12/07/18** - Added a step by step installation guide for MinKNOW + read_until_api + third party Python package (pytorch) for Linux at the bottom of the page.
...
Installation guide for Minknow + read_until_api + third party Python package (pytorch) for Linux
--------------------
